...
Feature: Tests for formalizedplacementrep in msan
  ...
  @execute
  Scenario: formalizedplacementrep-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/msan/raw/formalizedplacementrep/${version}/formalizedplacementrep.rep.conf
