...
Feature: Tests for auditfloorplan in msan
  ...
  @execute
  Scenario: auditfloorplan-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/mx/msan/raw/auditfloorplan/${version}/auditfloorplan.rep.conf
